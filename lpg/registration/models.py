...
from landingpages.models import LandingPage, Account, Domain
...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, password, email,
        ...
        '''
        Grant Account Add permissions to establish a profile
        '''
        new_user.user_permissions.add(get_perm(Account,
